...
export function CartIsland() {
  ...
  return (
    <div
      ref={rootRef}
      className="fixed bottom-6 left-1/2 z-90 w-max -translate-x-1/2 max-[640px]:bottom-4"
    >
      {expanded ? (
        <div
          ref={panelRef}
        ...
        <button
          ...
          className="flex cursor-pointer items-center gap-3 whitespace-nowrap rounded-full border border-white/10 bg-brand px-6 py-3.5 font-display font-medium text-white shadow-2xl transition-transform hover:-translate-y-0.5"
        >
